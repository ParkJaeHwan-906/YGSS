...
import pickle
import joblib
from model_trainer import time_split_by_id
...
os.environ['CUDA_VISIBLE_DEVICES'] = '0'  # GPU 1 (할당된 번호) 사용
...
class HybridRecommenderSystem:
    ...
    def train_lstm_model(self, etf_data, etf_code, epochs=100):
        ...
        X_train, X_val, y_train, y_val = time_split_by_id(
            X, y, 'return', train_ratio=0.8
        )
