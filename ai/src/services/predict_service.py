...
def predict_all(
    ...
    for asset_id_prefix, g in grouped:
        ...
        scaled_features = lstm_data['feature_scaler'].transform(g[regression_group])
        scaled_target = lstm_data['target_scaler'].transform(g[["return"]])
        ...
        lstm_pred = float(lstm_data['target_scaler'].inverse_transform(pred_scaled)[0][0])
